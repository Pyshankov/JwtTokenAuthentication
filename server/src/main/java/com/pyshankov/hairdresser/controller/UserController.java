...
import com.pyshankov.hairdresser.dto.*;
...
//        inject current user location, and find all freelance account in specified range
    ...
    @ResponseBody
    public void createAccountForUser(@PathVariable String userName, @RequestBody AccountDto accountDto){
        repository.createAccountForUser(userName, FromDto.fromCreateAccountDto(accountDto));
    }
